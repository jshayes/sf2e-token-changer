                ...
                <div class="sf2e-token-state-editor__multiselect" on:pointerdown|stopPropagation>
                  <div class="form-fields">
                    ...
                    <button
                      ...
                      on:pointerdown|stopPropagation|preventDefault={() => setOpenConditionPickerKey(openConditionPickerKey === `token-state-modal:${conditionIndex}` ? null : `token-state-modal:${conditionIndex}`)}
                    >
